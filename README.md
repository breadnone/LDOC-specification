...
properties : tag, type, param, embeddable, isstatic, prop, pair, noscope, valueref, endwith
...
[tag:page, type="int", param="title", type="string", valueref="pageNumber", param="author", type="string", embeddable="false", isstatic="false", pair="false"]
...
[prop:halign-center, type="int", param="ha-c", pair=true, embeddable="true", isstatic="false"]
[prop:halign-right, type="int", param="ha-r", pair=true, embeddable="true", isstatic="false"]
[prop:halign-left, type="int", param="ha-l", pair=true, embeddable="true", isstatic="false"]
[prop:valign-left, type="int", param="va-l", pair=true, embeddable="true", isstatic="false"]
[prop:valign-center, type="int", param="va-c", pair=true, embeddable="true", isstatic="false"]
[prop:valign-right, type="int", param="va-r", pair=true, embeddable="true", isstatic="false"]
...
//Page declaration can also includes "content" mbedding like this : [page:1, Title="Testing Specs Implementation", margine="6,6,6,6", pad="2,2,2,2" endwith=content]
This is regular text, along with other river of texts

[h2, 0, halign-left] Tag Pairing Header Example.// the "align-left" will align the header to left. opetions are : left, center, right, default is left. "0" mean no extra space/indent.
...
[h2, 0, halign-center] //OR can be written using the param like this [h2, 0, ha-c]
...
[h2, 0, halign-left]Data Summary Table[/h2, 2]
